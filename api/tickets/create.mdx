...
description: "POST /api/v1/tickets creates a support ticket, runs AI classification and RAG search, and returns the persisted ticket object with HTTP 201 Created."
---
