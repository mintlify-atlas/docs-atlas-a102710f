---
title: "GET /api/v1/tickets — List All Support Tickets by Status"
sidebarTitle: "List Tickets"
description: "GET /api/v1/tickets returns all support tickets sorted by created_at descending. Pass the status query param to filter by ticket lifecycle stage."
---
