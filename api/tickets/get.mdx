---
title: "GET /api/v1/tickets/:id — Fetch a Single Ticket by ID"
sidebarTitle: "Get Ticket"
description: "GET /api/v1/tickets/:id retrieves a single support ticket by numeric ID. Returns 404 with an error message when the ticket does not exist in the database."
---
